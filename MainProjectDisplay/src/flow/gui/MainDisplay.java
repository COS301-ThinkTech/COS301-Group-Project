...
public class MainDisplay extends javax.swing.JFrame 
{
    ...
    {
        consoleInternalFrame.hide();
        Dimension screenSize = Toolkit.getDefaultToolkit().getScreenSize();
        double width = screenSize.getWidth();
        double height = screenSize.getHeight();
        super.paint(g);
        jPanel2.setSize(jPanel2.getWidth(),(int)height-170);
        jTabbedPane1.setSize(jTabbedPane1.getWidth(), jPanel2.getHeight()-60);
        jToolBar2.setLocation(jToolBar2.getX(),jTabbedPane1.getHeight()+10 );
        componentsInternalFrame.setSize(componentsInternalFrame.getWidth(),  jPanel2.getHeight());     
