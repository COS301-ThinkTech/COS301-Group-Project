...
public class structEditor extends javax.swing.JPanel implements BlockEditor {
    ...
    private void initComponents() {
        ...
        addField.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/16/document-new.png"))); // NOI18N
        java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("config/lang/lang"); // NOI18N
        addField.setText(bundle.getString("structEditor.add")); // NOI18N
        ...
        setBorder(javax.swing.BorderFactory.createTitledBorder(bundle.getString("structEditor.struct"))); // NOI18N

        jLabel1.setText(bundle.getString("structEditor.name")); // NOI18N

        fieldsPane.setLayout(new java.awt.GridLayout(200, 1));
        jScrollPane1.setViewportView(fieldsPane);

        iface.setText(bundle.getString("structEditor.genInterface")); // NOI18N
