 ...
 */
package flowchart.Components;

import flowchart.Component;
...
public class DecisionComponent extends Component{
    ...
    public DecisionComponent(Flowchart parent){
    ...
    @Override
    public Connector connectTo(Component n){
    ...
    @Override
    public Component executeCode(ScriptEngine script){
